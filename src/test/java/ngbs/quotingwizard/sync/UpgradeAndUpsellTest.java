...
@Tag("NGBS")
@Tag("SyncWithNGBS")
public class UpgradeAndUpsellTest extends BaseTest {
    ...
    public UpgradeAndUpsellTest() {
        var data = JsonUtils.readConfigurationResource(
                "data/ngbs/sync/RC_MVP_Monthly_Contract_163106013.json",
                Dataset.class);
    ...
    @Test
    @TmsLink("CRM-12754")
    @DisplayName("CRM-12754 - Upgrade + Upsell with optional Discounts for the existing contract")
    ...
    public void test() {
        ...
        step("2. Select another package with a contract on the Select Package tabø", () ->
        ...
        step("4. Open the Price tab, set quantity for DL Unlimited = " + dlUnlimitedCore.quantity + ", " +
            ...
            steps.syncWithNgbs.stepSetupQuantitiesAndDiscounts(dlUnlimitedCore, steps.quoteWizard.localAreaCode, phoneToAdd);
            cartPage.saveChanges();
        });

        step("5. Close the Opportunity and set ServiceInfo__c.UpgradeStepStatus__c = true via API", () -> {
