...
@Tag("NGBS")
@Tag("SyncWithNGBS")
public class UpgradeAndUpsellNonContractTest extends BaseTest {
    ...
    public UpgradeAndUpsellNonContractTest() {
        var data = JsonUtils.readConfigurationResource(
                "data/ngbs/sync/RC_MVP_Monthly_NonContract_163113013.json",
                Dataset.class);
        ...
        expectedSyncSteps = List.of(DISCOUNT_SYNC_STEP, UPGRADE_STEP, ORDER_SYNC);
    ...
    @Test
    @TmsLink("CRM-12746")
    @DisplayName("CRM-12746 - Upgrade + Upsell with optional Discounts")
