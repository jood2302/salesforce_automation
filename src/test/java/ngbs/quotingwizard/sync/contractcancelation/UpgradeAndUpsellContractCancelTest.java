...
@Tag("NGBS")
@Tag("SyncWithNGBS")
public class UpgradeAndUpsellContractCancelTest extends BaseTest {
    ...
    public UpgradeAndUpsellContractCancelTest() {
        var data = JsonUtils.readConfigurationResource(
                "data/ngbs/sync/RC_MVP_Monthly_Contract_186644013.json",
                Dataset.class);
        ...
        expectedSyncSteps = List.of(CONTRACT_CANCEL_STEP, DISCOUNT_SYNC_STEP, UPGRADE_STEP, ORDER_SYNC);
    ...
    @Test
    @TmsLink("CRM-19603")
    @DisplayName("CRM-19603 - Contract cancellation with Upgrade + Upsell with optional Discounts.")
