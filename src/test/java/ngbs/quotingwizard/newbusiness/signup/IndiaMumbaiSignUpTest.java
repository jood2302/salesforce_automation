...
public class IndiaMumbaiSignUpTest extends BaseTest {
    ...
    @Test
    @TmsLink("CRM-25036")
    @DisplayName("CRM-25036 - Sign Up India (Mumbai) opportunity")
    @Description("Verify that Indian (Mumbai) opportunity can be signed up and proper data is transferred to the funnel")
    public void test() {
