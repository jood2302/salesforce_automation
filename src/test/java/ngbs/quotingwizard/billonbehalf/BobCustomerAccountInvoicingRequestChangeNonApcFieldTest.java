...
@Tag("P0")
@Tag("Bill-on-Behalf")
public class BobCustomerAccountInvoicingRequestChangeNonApcFieldTest extends BaseTest {
    ...
    //  Test data
    private final String initialNumberOfDevices;

    public BobCustomerAccountInvoicingRequestChangeNonApcFieldTest() {
    ...
    @Issue("PBC-19777")
    @TmsLink("CRM-24579")
    @DisplayName("CRM-24579 - Invoicing request for BoB Customer Accounts (Change anything other than APC)")
    ...
    public void test() {
        ...
        step("2. Change number of 'Initial Number of Devices'", () -> {
            bobApprovalCreationModal.initialNumberOfDevicesInput.setValue(initialNumberOfDevices);
        });
        ...
        step("4. Set Status__c = 'Approved' for the created Invoicing Request Approval via API", () -> {
        ...
        step("5. Check that the Payment method on the Customer Account is changed to 'Invoice' in both NGBS and SFDC, " +
