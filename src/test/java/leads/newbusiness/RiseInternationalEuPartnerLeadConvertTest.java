...
@Tag("GSPBrands")
@Tag("LeadConvert")
public class RiseInternationalEuPartnerLeadConvertTest extends BaseTest {
    private final ProServOnlyPartnerLeadConvertSteps proServOnlyPartnerLeadConvertSteps;

    public RiseInternationalEuPartnerLeadConvertTest() {
        proServOnlyPartnerLeadConvertSteps = new ProServOnlyPartnerLeadConvertSteps(3);
    }
